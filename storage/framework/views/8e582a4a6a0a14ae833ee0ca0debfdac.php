...
<body class="antialiased bg-gray-50 dark:bg-gray-900">
    ...
    <div class="relative min-h-screen">
        <header class="p-6 flex justify-between items-center max-w-7xl mx-auto">
            <!-- Logo  -->
            <a href="<?php echo e(url('/')); ?>" class="text-2xl font-bold text-gray-900 dark:text-white">
                ...
                <?php if(Route::has('login')): ?>
                    ...
                    <?php else: ?>
                        ...
                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="ml-4 font-semibold text-white bg-red-600 hover:bg-red-700 px-4 py-2 rounded-lg shadow-md transition duration-150 ease-in-out">
                                Register
                            </a>
                        <?php endif; ?>
                    <?php endif; ?>
        ...
        <footer class="py-4 text-center text-sm text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700">
            &copy; <?php echo e(date('Y')); ?> OharaAlexandria - Sistem Peminjaman Perpustakaan.
        </footer>
    </div>
</body>
</html><?php /**PATH C:\laragon\www\librarybook\resources\views/welcome.blade.php ENDPATH**/ ?>